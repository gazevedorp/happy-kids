...
const PasswordReset: React.FC = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden flex-col xl:flex-row">
      ...
      {/* Painel Esquerdo */}
      <div className="relative flex w-full min-h-screen flex-col items-center justify-center bg-white p-6 xl:w-[40%] xl:p-8 transition-all duration-300 max-[1366px]:mx-auto max-[1366px]:w-full max-[1366px]:justify-center">
